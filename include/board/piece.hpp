...
// as well as various helper functions for dealing with pieces.static class
...
public:
  ...
  static piece makePiece(piece_t piece_class, bool pieceIsWhite) {
    makePiece(piece_class, pieceIsWhite ? White : Black);
  }
  ...
  static char getPieceCharacter(piece_t piece) {
    ...
    pieceCharacter =
        isWhite(piece) ? pieceCharacter : std::tolower(pieceCharacter);
